...
public class ParkingSpaceController {
    ...
    public ResponseEntity<ParkingSpace> createSpace(@RequestBody ParkingSpaceRequest request) {
        return ResponseEntity.ok(parkingSpaceService.createParkingSpace(request));
    }
    ...
    public ResponseEntity<List<ParkingSpace>> getAvailableSpacesByCity(@PathVariable String city) {
        return ResponseEntity.ok(parkingSpaceService.getAvailableSpacesByCity(city));
    }
    ...
    public ResponseEntity<ParkingSpace> updateStatus(@PathVariable Long id, @RequestBody StatusUpdateRequest request) {
        return ResponseEntity.ok(parkingSpaceService.updateSpaceStatus(id, request.getStatus()));
    }
